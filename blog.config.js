...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎来到 亿威力 无限连结',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ewili.com', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '亿威力', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.ewili.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '外汇,股票,期货,数字货币,量化,量化交易,软件,软件开发,人工智能,LLM,大语言模型', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '378981649@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '亿威力', // 站点描述，被notion中的页面描述覆盖
